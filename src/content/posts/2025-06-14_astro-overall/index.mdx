...
date: 2025-06-14
headerImg: cobra_monster_commits.png
headerImgCaption: Added a few months after the fact...but wowee that's a lot of commits for a personal site!
tags:
  - webdev
---
...
const posts = defineCollection({
  ...
  schema: ({ image }) =>
    z.object({
      ...
      emoji: z.preprocess((val) => `@assets/mutantEmoji/${val}`, image()).optional(),
    }),
});
```
