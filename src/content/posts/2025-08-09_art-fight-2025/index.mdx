...
date: 2025-08-09
headerImg: "art_fight_2025_results.png"
headerImgCaption: "Fossils!! I thought we had it in the bag..."
tags:
  - art
  - art-fight
  - furry
...
This season was Crystals vs. Fossils, and at time of writing the winner hasn't been declared yet, but I'm confident that my fellow Fossils pulled out the win <InlineArgentEmoji emoji="triumph"/>
...
![Slick angled drawing of Argent shredding with a sick bicycle move](https://images.artfight.net/attack/BUv1VxAVTwPb4O2KHgpJJyDHtoSQ6Aeik1UUgw3xE8AK896i6mkp7X64s7d0.png?t=1753214731)
        ...
        <span slot="caption">Jasper's style is so fucking sick. I only wish I could look even half as cool on a bike <InlineArgentEmoji emoji="weary"/> <a href="https://artfight.net/attack/11928960.bike-back">Artfight Link</a></span>
    </AccordionPhotoTemplate>
    </div>
</Accordion>
...
Anyways make sure to check out [Pavlentine on Bluesky](https://bsky.app/profile/pavlentine.bsky.social) b/c they have a really cool pixel art style and obviously a very cool cobra OC <InlineArgentEmoji emoji="smirk" />
...
<Accordion client:visible>
<span slot="title">Some of Pinecone's Art Fight 2025 Attacks + Revenge <InlineArgentEmoji emoji="smile"/></span>
<div slot="content">
...
<span slot="caption">I was absolutely blown away by this. I still am!! It's gorgeous <InlineArgentEmoji emoji="pleading" /> <a href="https://artfight.net/attack/12245842.argent">Art Fight link</a></span>
</AccordionPhotoTemplate>
...
Proud of:
1. Muscle!!! <InlineArgentEmoji emoji="triumph"/>
...
A revenge piece for the undisputed _raddest_ Argent piece I got this year...! I saw this super cool cyborg scalie with _zero_ attacks and knew I had to break that terrible trend <InlineArgentEmoji emoji="triumph"/>
...
I just _had_ to draw Diamondback. [Ed](https://yiff.life/@goodjobrammy) is a very cool friend and has even cooler characters! And obviously if Argent was gonna wrestle any of them, he'd surely lose.

For this piece it was just so important that I drew Diamondback looking Cool Buff and "Wrestler". I quickly decided on a challenging "leaning towards the viewer" type of extreme angle...and while I didn't nail it, I think I did OK.

Also pretty pleased with the expression! I very gratefully had a nice reference from a previous attacker to help me with the face...again, non-scalie furries are a weakness!

Proud of:
1. Overall vibe/energy
2. Hair and ears
3. Shading

Room for improvement:
1. Pushing the pose
2. Better face/head shape
3. Outfit textures/lighting

<Accordion client:visible>
    <span slot="title">Ed's Revenge! ⚔️</span>
    <div slot="content">
    <AccordionPhotoTemplate numImages={1} numCaptions={1}>
        <div slot="image">
![Black and white drawing of Argent and Diamondback at a coffee shop--Argent is waving to someone off screen, Di is covetously measuring Argent's bicep with tailor's tape](https://images.artfight.net/attack/Cci7JlPgxAW9ZvTNnSTTg4EFv5CvONceWMqyXcRmLP32e70JuxiGW0YUFQbe.jpg?t=1754022507)
        </div>
        <span slot="caption">I can't believe Ed had time to bash out this incredible revenge...but also one so good?? The musculature is crazy good and the energy of Di is hilarious <a href="https://artfight.net/attack/12776362.coffee-after">Artfight Link</a></span>
    </AccordionPhotoTemplate>
    </div>
</Accordion>
...
![Full-body piece featuring a cool, buff, pink Naga snake. He's simply posing and flashing a peace sign with his fingers to the camera.](@assets/myArt/artFight2025/Ruheg.png)

My final piece this year! Finished with 2 hours to spare, I didn't think I'd have enough time to polish this as much as I did but I guess when I'm drawing scalie characters it's a lot easier to get comfortable haha.

(Nearly) every year [Somite](https://bsky.app/profile/sixinchfinch.bsky.social) and I exchange blows on Art Fight, and I contributed to it at the eleventh hour here with something just kinda fun and _beefy_ for my own sake haha.

Just had fun rendering big muscles! And the hand turned out real nice...glad I thought to add some fingerprint stylization at the end because it really adds a lot :3
...
Room for improvement:
1. Scale textures
2. Less obvious "didn't have time to draw a 2nd hand" pose
3. Whatever is going on below the waist of a naga <InlineArgentEmoji emoji="thinking"/>

<Accordion client:visible>
    <span slot="title">Somite's Revenge! ⚔️</span>
    <div slot="content">
    <AccordionPhotoTemplate numImages={1} numCaptions={1}>
        <div slot="image">
![Daneer, an anthro male deer with golden antlers, teeing off in golf swing, prominent booty facing the camera](https://images.artfight.net/attack/tPwqZIV5APyrs2C7Kj3Cltv1m0ITgJVnxoNrtUYOVTPqza8MTYDt7bBGOL5d.png?t=1754071205)
        </div>
        <span slot="caption">Absolutely unbelievable that Somite had time to put this out. The timestamp literally lists it as 5 seconds _past_ the end of the event...absolute madlad. Incredible pose and quality for that time!! So delighted to get a last-minute Daneer piece :3 <a href="https://artfight.net/attack/12913473.revenge">Artfight Link</a></span>
    </AccordionPhotoTemplate>
    </div>
</Accordion>
...
Due to life events but especially development efforts for \*this website\*, I hadn't done much drawing in the past year...Once July started creeping up I threw all my chips into an explosive Art Fight revival moment for myself, and I'm pretty pleased with the results!

Art fight means a lot to me. This was my 8th year, and I'm grateful for the site and the folks who work hard to keep the event going. It's become a kind of time capsule of my own interests and artistic development, and that's really neat.

But most of all I'm grateful to all my wonderful friends and future-friends who made it another fun year of back-to-back attacks against one another :3

I haven't drawn since the event ended, but I'm still feeling that drive. I want to draw more! Improve my painting, and be more involved with the furry community in general—through art and otherwise! <InlineArgentEmoji emoji="smile"/>
