		...
		<html xmlns="http://www.w3.org/1999/xhtml">
			...
			<body>
				<nav class="intro">
					<div class="container">
						<div>
							...
							<p>
								<small> Visit <a href="https://aboutfeeds.com">About Feeds</a> to
									get started with newsreaders and subscribing. It’s free. </small>
							</p>
						</div>
					...
					<section class="recent">
						...
						<xsl:for-each select="/atom:feed/atom:entry">
							<div class="pb-5">
								...
								<small class="meta"> Published: <xsl:value-of
										select="atom:published" />
								</small>
							</div>
						</xsl:for-each>
					</section>
				...
				<script>
					function subtome() {
					(function(){var
					z=document.createElement('script');z.src='https://www.subtome.com/load.js';document.body.appendChild(z);})()
					}
				</script>
			</body>
		</html>
